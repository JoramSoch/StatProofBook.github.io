...
$$ \label{eq:post-ind-cond-s2}
\begin{split}
p(\theta|y_1,y_2) &\overset{\eqref{eq:post-ind-cond-s1}}{=} \frac{p(y_1,y_2|\theta) \cdot p(\theta)}{p(y_1,y_2)} \\
